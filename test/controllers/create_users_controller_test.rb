...
class CreateUsersControllerTest < ActionController::TestCase
  ...
  test "should create create_user" do
    assert_difference('CreateUser.count') do
      post :create, create_user: { emaile: @create_user.emaile, name: @create_user.name, password: @create_user.password }
    end
  ...
  test "should update create_user" do
    patch :update, id: @create_user, create_user: { emaile: @create_user.emaile, name: @create_user.name, password: @create_user.password }
    assert_redirected_to create_user_path(assigns(:create_user))
  end
