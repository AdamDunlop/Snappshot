...
class BusinessCardsControllerTest < ActionController::TestCase
  ...
  test "should create business_card" do
    assert_difference('BusinessCard.count') do
      post :create, business_card: { company: @business_card.company, company_address: @business_card.company_address, email: @business_card.email, job_title: @business_card.job_title, name: @business_card.name, phone: @business_card.phone }
    end
  ...
  test "should update business_card" do
    patch :update, id: @business_card, business_card: { company: @business_card.company, company_address: @business_card.company_address, email: @business_card.email, job_title: @business_card.job_title, name: @business_card.name, phone: @business_card.phone }
    assert_redirected_to business_card_path(assigns(:business_card))
  end
